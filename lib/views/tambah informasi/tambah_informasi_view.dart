...
import 'package:agro_app/views/tambah%20informasi/controllers/tambah_informasi_controller.dart';
import 'package:agro_app/views/tambah%20informasi/widgets/custom_input_field.dart';
import 'package:agro_app/views/tambah%20informasi/widgets/date_picker_field.dart';
import 'package:agro_app/views/tambah%20informasi/widgets/luas_bero_field.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class TambahInformasiView extends StatelessWidget {
  TambahInformasiView({super.key});

  final TambahInformasiController controller = Get.put(
    TambahInformasiController(),
  );
